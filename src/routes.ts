...
import { addToOrderHandler, createOrderHandler, deleteOrderHandler, getClientOrdersHandler, getOrderHandler, getOrdersHandler, publicGetOrderHandler, removeFromOrderHandler, updateOrderHandler } from './controller/order.controller';
...
//     Delete user account
    ...
    app.get('/public/orders/:clientId',
